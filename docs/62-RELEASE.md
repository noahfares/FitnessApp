...
- [ ] Release workflow succeeded; APK attached with checksums.
...
- [ ] App bundle (`F-REL-004`).
- [ ] Store listing: title, short and full description, category.
- [ ] Graphics: icon, feature graphic, phone screenshots (`F-THM-006`).
      Screenshots need realistic training data — build a seeded demo database,
      which is a useful test fixture regardless.
