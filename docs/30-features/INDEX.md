...
166 features. For machine-readable project state see [`../features.tsv`](../features.tsv); it answers most questions without opening a spec.
...
| [F-LOG-024](LOG/F-LOG-024.md) | Live rolling volume in the set row | 6 | P2 | done |
...
| [F-THM-007](THM/F-THM-007.md) | Apple-style visual redesign — light and dark | 6 | P2 | done |
| [F-THM-008](THM/F-THM-008.md) | Unify large-title header across Home, Routines, History, Insights | 6 | P2 | done |
